              ...
              {editingTime?.id === activeRecord.id ? (
                <div className="mt-5 rounded-2xl bg-[var(--color-surface-hover)] p-4">
                  ...
                  <div className="mt-3 flex gap-2">
                    <AsyncButton onClick={handleSaveTime} busy={savingTime} busyLabel="正在保存…" disabled={!editingTime.value} className="theme-accent-button flex-1 rounded-2xl px-4 py-3 text-sm font-medium transition-all disabled:cursor-not-allowed disabled:opacity-50">保存</AsyncButton>
                ...
                <div className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-3 xl:grid-cols-1 2xl:grid-cols-3">
                  ...
                  <AsyncButton onClick={() => openUndoPreview(activeRecord.id)} busy={undoing} busyLabel="正在检查…" disabled={deleting || savingTime} className="theme-accent-soft flex items-center justify-center gap-2.5 rounded-2xl px-4 py-3 text-sm font-medium transition-all disabled:cursor-not-allowed disabled:opacity-50">
